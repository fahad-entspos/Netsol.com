...
function Header() {
    ...
    {/* HEADER COMPONENT */}
      ...
      <div className="flex  flex-col md:flex-row h-screen bg-gradient-to-t to-[#0f101c] from-[#171a80]">
        ...
        <Link href={"/home"}>
          {scrolling ? (
            <img
              className="mt-1 md:mt-1 md:mr-4 left-4 fixed top-6 md:top-[4%] md:left-16 h-12 md:h-16 w-auto cursor-pointer"
              src="download (1).webp"
              alt="Scrolling Image"
            />
          ) : (
          ...
          <div>
            <button
              ...
              className="bg-transparent text-white px-4  py-2 rounded mt-1 md:mt-1 pt-2 md:mr-4 fixed top-3 right-5 md:top-[44%] md:left-11 w-[60px]"
            >
              {isSidebarOpen ? (
                <>
 <span className={` ${scrolling ? "text-blue-900" :"text-white"  }   text-white pl-2 text-lg font-TisaOT `}>                    
                    Close
                  </span>
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    className={` w-14 h-14 ${scrolling ? "text-[#1c72b8]" :"text-white"  } `}
                  >
                    <path
                      strokeLinecap="round"
 ...
 <span className={` ${scrolling ? "text-blue-900" :"text-white"  }    text-white pl-0  lg:pl-1 text-sm lg:text-base  font-TisaOT `}>                    MENU
                  </span>
                  <IoReorderThreeOutline className={` ${scrolling ? "text-[#1c72b8]" :"text-white "  } w-[38px]  lg:w-[52px]  h-[38px]  lg:h-[52px]    text-base font-EurostileExt `} />
                </>
              )}
            </button>
  ...
  <Link href={"/contact-us"}>
                ...
                >
                  {isSidebarOpen ? (
                    ...
                    <>
                      <span className=" text-white  pl-1  lg:pl-1 text-xs lg:text-base font-EurostileExt ">
                        Menu
                      </span>
                      <IoReorderThreeOutline className="w-[52px] h-[52px] " />
                    </>
                  )}
                </button>
          ...
          "/events" === pathname
            ...
            : 'text-white'
                ...
                <button className="bg-transparent border-2 font-TisaOT  rounded-full text-white  h-[70px] w-[70px] mt-1 mx-auto fixed left-0 right-0 top-[85%] hover:bg-white hover:text-[#1c72b8] transition duration-500 ease-in-out transform text-xs   font-light">
                  SMART
                  <h1>NAV</h1>
                </button>
                </Link>
        ...
        <div className="   md:flex-1 flex items-center  ">
          <div className=" mt-[50%] md:mt-0 w-[70%] sm:w-full md:w-[70%] ml-[24px] lg:w-[55%]">
            <h1 className="text-6xl font-TisaOT  sm:text-6xl md:text-6xl lg:text-6xl xl:text-6xl 2xl:text-6xl font-semibold text-[#1c72b8]">
              adaptive
            </h1>
            <h1 className="text-4xl font-TisaOT  sm:text-4xl md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-4xl mt-4 font-semibold text-white">
              to your business, your growth & the future.
            </h1>
            <h1 className="text-base  font-TisaOT sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-xl mt-4 text-white">
        ...
        <button className="bg-transparent border-2 font-TisaOT rounded-full text-white  h-[70px] w-[70px]  absolute  top-[85%]  mx-auto  left-0 right-0       hover:bg-white hover:text-[#1c72b8] transition duration-500 ease-in-out transform text-xs font-EurostileExt  font-light">
          EXPLORE
        </button>
...
<div className="flex   flex-col md:flex-row h-screen ">
    ...
    <div className="md:flex-1 flex-col flex ml-[0px] lg:ml-[124px]">
...
{showNotification && (
  ...
  >
    ...
    <div>
      <motion.button
        type="button"
        className="bg-[#1c72b8] mt-1 min-h-8 border text-start border-[#1c72b8] rounded-bl-full rounded-tr-full rounded-br-full px-5 py-3 text-white text-xs font-normal"
        whileHover={{ scale: 1.05, transition: { duration: 0.3 } }}   // Animation on hover
      >
...
<div>
<motion.button
  whileHover={{ scale: 1.1, backgroundColor: '#1c72b8', color: 'white', boxShadow: '0px 8px 20px rgba(0, 0, 0, 0.1)', transition: { duration: 0.3, ease: 'easeInOut' } }}
  whileTap={{ scale: 0.9 }}  // Decrease scale on click
  className="bg-transparent border border-[#1c72b8] rounded-3xl text-[#1c72b8] mt-3 px-6 py-2 text-sm font-semibold"
>
  EXPLORE
</motion.button>
</div>
